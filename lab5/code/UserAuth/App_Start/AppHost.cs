...
[assembly: WebActivator.PreApplicationStartMethod(typeof(UserAuth.App_Start.AppHost), "Start")]
...
namespace UserAuth.App_Start
{
	...
	{		
		public AppHost() //Tell ServiceStack the name and where to find your web services
			: base("StarterTemplate ASP.NET Host", typeof(UserData).Assembly) { }
		...
		public override void Configure(Funq.Container container)
		{
			...
			Routes
			  .Add<UserData>("/hello")
              .Add<UserData>("/hello/{username}/{password*}");
